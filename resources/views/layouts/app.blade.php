...
<head>
    ...
    <script src="{{asset('plugins/src/font-icons/feather/feather.min.js')}}"></script>
    ...
    @vite(['resources/scss/light/assets/elements/tooltip.scss'])
    @vite(['resources/scss/dark/assets/elements/tooltip.scss'])
    ...
    @vite('resources/js/libs/jquery.maskMoney.js')
</head>
<body class="{{ Request::routeIs('error404') ? 'error text-center' : '' }}
    ...
    {{
        ...
        Request::routeIs('student.login-vue')) ? 'form' : ''
    }}
    {{
