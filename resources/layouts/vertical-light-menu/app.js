    ...
    var toggleFunction = {
                ...
                el.addEventListener('click', function (sidebar) {
                    ...
                    if ($recentSubmenu === true) {
                        if (document.querySelector('.collapse.submenu').classList.contains('show')) {
                            ...
                            if (Dom.class.mainContainer && Dom.class.mainContainer.classList.contains('sidebar-closed')) {
        ...
        onToggleSidebarSubmenu: function () {
            ['mouseenter', 'mouseleave'].forEach(function (e) {
                if (!document.querySelector('.sidebar-wrapper')) return;
        ...
        overlay: function () {
            if (document.querySelector('#dismiss, .overlay')) {
    ...
    function sidebarFunctionality() {
        function sidebarCloser() {
            ...
            if (window.innerWidth <= 991) {
                ...
                if (!document.querySelector('body').classList.contains('alt-menu') && Dom.id.container) {
                ...
                if (!document.querySelector('body').classList.contains('alt-menu') && Dom.id.container) {
                    ...
                    let elementSidebarWrapper = document.querySelector('.sidebar-wrapper [aria-expanded="true"]');
                    if (elementSidebarWrapper) {
                        if (elementSidebarWrapper.parentNode.querySelector('.collapse')) {
                            elementSidebarWrapper.parentNode.querySelector('.collapse').classList.remove('show');
                        }
                    }
                }
            }
