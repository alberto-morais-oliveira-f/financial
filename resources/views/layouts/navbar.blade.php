                   ...
                   data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="avatar-container">
                        <div class="avatar avatar-sm avatar-indicators avatar-online">
                            @if (\Illuminate\Support\Str::contains(auth()->user()->image, 'picsum'))
                                @php
                                    $image = \Illuminate\Support\Str::replace('http://127.0.0.1:8000/storage/','', auth()->user()->image)

                                @endphp
                                <img alt="avatar" src="{{ $image }}" class="rounded-circle">
                            @else
                                <img alt="avatar" src="{{ asset(auth()->user()->image) }}" class="rounded-circle">
                            @endif
                        </div>
                    </div>
                </a>
